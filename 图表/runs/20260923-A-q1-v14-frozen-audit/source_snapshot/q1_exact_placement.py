...
class PartitionEvaluator:
    def __init__(self, raw, bandwidth, capacity, cross, same, max_partitions=2):
        ...
        original = self.module.evaluate_scene_a
    ...
    def _build(self, raw, plan, bandwidth, capacity):
        ...
        if key not in self.cache:
            built = self.module._build_scene_a_tasks(raw, plan, bandwidth, capacity)
