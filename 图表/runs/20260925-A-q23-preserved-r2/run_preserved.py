...
p=pathlib.Path('图表/runs/20260925-A-q23-preserved-r2');c=json.loads((p/'contract.json').read_text())
...
for q,i in [(2,65),(2,33),(3,44),(3,5)]:one(q,i,'guided',True)
(p/'execution_complete.json').write_text(json.dumps(dict(finished_unix=time.time(),trials=20,benchmarks=4,workers=4)))
