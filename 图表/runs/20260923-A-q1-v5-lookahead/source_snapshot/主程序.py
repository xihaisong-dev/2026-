...
def main(argv=None):
    ...
    run.add_argument('--features', nargs='*', default=[],
                     choices=['local_cost', 'critical', 'adaptive', 'portfolio', 'insertion', 'comm_rank', 'lookahead'])
    ...
    if args.evaluation_budget < 1 or (args.features and not args.experimental):
        ...
        for cores in args.cores:
            ...
            if args.experimental:
                ...
                plan, result, stats = solve_experimental(graph.raw, settings, waits, cores,
                    args.evaluation_budget, args.seed, args.features, progress)
            else:
