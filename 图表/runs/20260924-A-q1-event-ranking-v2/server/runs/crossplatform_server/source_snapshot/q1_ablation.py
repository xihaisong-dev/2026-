...
CONFIGS.update({
    'shared_resource': BASE_FEATURES + ['partition_guard', 'shared_input', 'region', 'resource_init'],
...
for name, extra in {
    ...
    'component_local_rank': ['init_components', 'component_guard', 'component_slot', 'component_followup', 'component_local_rank'],
...
CONFIGS['routes_unguarded'] = CONFIGS['component_local_rank'] + ['bounded_routes', 'fast_contractions']
CONFIGS['routes_event_guarded'] = CONFIGS['routes_unguarded'] + ['event_opportunity']
CONFIGS['routes_guarded'] = CONFIGS['routes_unguarded'] + ['opportunity_gate']
