...
EXTRA_FEATURES = frozenset({'insertion', 'comm_rank', 'lookahead', 'calibrated', 'joint', 'budget_adapt', 'ddr', 'guarded_joint', 'beam', 'partition_guard', 'shared_input', 'local_repair', 'repair_move'})
...
def solve_experimental(raw, settings, waits, cores=4, evaluation_budget=12, seed=0,
    ...
    if features & {'shared_input', 'local_repair', 'repair_move'} and 'partition_guard' not in features:
