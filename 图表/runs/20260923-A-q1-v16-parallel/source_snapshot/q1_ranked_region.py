...
def ranked_candidates(g, raw, plan, result, cores, wide=False, uphill=False, phase=False):
    frozen = FrozenCost(g, plan, result)
    ranker = LocalRank(raw, frozen.g, phase)
    info = {'kind': 'local_exact', 'phase': phase, 'wide': wide, 'uphill': uphill,
