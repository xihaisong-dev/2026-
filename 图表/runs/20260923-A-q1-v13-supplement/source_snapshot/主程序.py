...
def main(argv=None):
    ...
    run.add_argument('--features', nargs='*', default=[],
                     choices=['local_cost', 'critical', 'adaptive', 'portfolio', 'insertion', 'comm_rank', 'lookahead', 'calibrated', 'joint', 'budget_adapt', 'ddr', 'guarded_joint', 'beam', 'partition_guard', 'shared_input', 'local_repair', 'repair_move', 'region', 'region_gap'])
