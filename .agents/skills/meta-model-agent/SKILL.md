...
> 本仓库 2026 GMCM/PDF 本地适配：先读 `references/competition-profiles/gmcm-2026.md`。该文件与 2026 profile 优先：默认无独立目录、正文无 30 页填充目标；下文上游通用或 DOCX 遗留示例不能覆盖这两项。此更新不代表 DOCX 导出器已按 2026 实测。
