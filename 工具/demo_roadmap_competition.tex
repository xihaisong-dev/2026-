% 模板 4 竞赛专用 demo — 多问题多行主节点 + 星号标注最优方法

% 配色：blue!80 主节点 + teal!70 子节点 + gray!40 虚线框

% 特点：每个问题可有 2 行（主节点+子节点），子节点 4 个一排，星号标注核心方法
...
\begin{tikzpicture}[scale=1.0,
  ...
  dashbox/.style={rectangle, draw=gray!40, dashed, line width=0.7pt,
...
\node[sub] (s0b) at (-1.4, -0.65) {Z-score标准化};
...
\node[main] (m1b) at (0, -4.7) {九种体质贡献度分析};
...
\node[main] (m2b) at (0, -9.6) {三级风险分层与规则挖掘};
...
\caption{研究技术路线图}\label{fig:roadmap}
