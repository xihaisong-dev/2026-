...
\begin{tikzpicture}[
    ...
    method/.style={rectangle, minimum width=3.4cm, minimum height=0.7cm, align=center,

        draw=blue!80, line width=0.7pt, fill=blue!6, font=\small,

        drop shadow={opacity=0.15, shadow xshift=0.5pt, shadow yshift=-0.5pt}},

    tool/.style={rectangle, minimum width=1.8cm, minimum height=0.5cm, align=center,

        draw=teal!70, line width=0.5pt, fill=white, font=\scriptsize},

    outputtag/.style={fill=blue!65, minimum width=1.5cm, minimum height=0.38cm, align=center,
    ...
    card/.style={fill=gray!2, draw=gray!25, dashed, line width=0.7pt},
