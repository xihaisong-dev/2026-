...
\begin{tikzpicture}[
    ...
    process/.style={rectangle, minimum width=4cm, minimum height=0.7cm, align=center,
    ...
    io/.style={rectangle, minimum width=3.5cm, minimum height=0.7cm, align=center,
...
\begin{tikzpicture}[
    ...
    stage/.style={rectangle, minimum width=2.4cm, minimum height=2.2cm, align=center,
    ...
    detail/.style={rectangle, minimum width=2.2cm, minimum height=0.5cm, align=center,
...
\begin{tikzpicture}[
    ...
    var/.style={rectangle, minimum width=3.2cm, minimum height=1cm, align=center,
    ...
    ctrl/.style={rectangle, minimum width=2.8cm, minimum height=0.7cm, align=center,
...
\begin{tikzpicture}[
    ...
    step/.style={rectangle, minimum width=3.8cm, minimum height=0.7cm, align=center,
    ...
    substep/.style={rectangle, minimum width=2.8cm, minimum height=0.6cm, align=center,
