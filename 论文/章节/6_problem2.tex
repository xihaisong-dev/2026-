...
\caption{三问逐图平均加速比（问题一取结构感知搜索；L2 单核沿用无 L2 参考）}\label{fig:q2-speed}\label{fig:q3-speed}
\end{figure}
...
\caption{三问百图总周期（问题一取结构感知搜索）}\label{fig:total-cycles}
\end{figure}
